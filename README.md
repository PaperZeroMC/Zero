...
Zero is a Purpur fork, Aimed at optimizing the player experience. It is a drop-in replacement for [Paper](https://github.com/PaperMC/Paper) servers built on top of [Paper](https://github.com/PaperMC/Paper/).
